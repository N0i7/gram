...
ref:"praepositionen",
explain:"<div class='ex' style='overflow:visible'><svg viewBox='0 0 320 220' style='width:100%;max-width:420px;display:block;margin:4px auto' role='img' aria-label='Venn-Diagramm: Akkusativ-Präpositionen, Dativ-Präpositionen und Wechselpräpositionen in der Mitte'><circle cx='115' cy='115' r='88' fill='#d70015' fill-opacity='0.22' stroke='#d70015' stroke-width='2'/><circle cx='205' cy='115' r='88' fill='#248a3d' fill-opacity='0.22' stroke='#248a3d' stroke-width='2'/><text x='60' y='55' font-size='13' font-weight='700' fill='#d70015' text-anchor='middle'>NUR AKKUSATIV</text><text x='60' y='80' font-size='11' fill='#1d1d1f' text-anchor='middle'>durch · für</text><text x='60' y='97' font-size='11' fill='#1d1d1f' text-anchor='middle'>ohne · um</text><text x='60' y='114' font-size='11' fill='#1d1d1f' text-anchor='middle'>gegen · bis</text><text x='260' y='55' font-size='13' font-weight='700' fill='#248a3d' text-anchor='middle'>NUR DATIV</text><text x='260' y='80' font-size='11' fill='#1d1d1f' text-anchor='middle'>aus · bei</text><text x='260' y='97' font-size='11' fill='#1d1d1f' text-anchor='middle'>mit · nach</text><text x='260' y='114' font-size='11' fill='#1d1d1f' text-anchor='middle'>seit · von · zu</text><text x='160' y='148' font-size='12' font-weight='700' fill='#5b3a86' text-anchor='middle'>WECHSEL</text><text x='160' y='163' font-size='10.5' fill='#1d1d1f' text-anchor='middle'>in · an · auf</text><text x='160' y='177' font-size='10.5' fill='#1d1d1f' text-anchor='middle'>über · unter · vor</text><text x='160' y='191' font-size='10.5' fill='#1d1d1f' text-anchor='middle'>hinter · neben · zwischen</text></svg><p style='text-align:center;font-size:13px;color:#6e6e73;margin:4px 0 0'>Akkusativ = wohin? (Bewegung) · Dativ = wo? (Position) · Wechsel = beides möglich, je nach Frage</p></div><p><b>an, auf, hinter, in, neben, über, unter, vor, zwischen</b> — der Fall hängt von der Frage ab:</p><table><tr><th>Wohin? → Akkusativ (Bewegung)<span class='en'>where to? movement</span></th><th>Wo? → Dativ (Position)<span class='en'>where? position</span></th></tr><tr><td>Ich gehe <b>in den</b> Park.<br>Ich lege das Buch <b>auf den</b> Tisch.</td><td>Ich bin <b>im</b> Park.<br>Das Buch liegt <b>auf dem</b> Tisch.</td></tr></table><p>Verb-Paare: <b>legen/liegen, stellen/stehen, setzen/sitzen</b> — Aktion/Position.</p><p class='en'>Movement (where to?) = accusative. Position (where?) = dative. Contractions: im = in dem, ins = in das, am, ans.</p>",
...
explain:"<p><b>Position 0</b> (Wortstellung normal): <b>und, oder, aber, denn</b>.<br><b>Position 1</b> (danach kommt sofort das Verb!): <b>deshalb, trotzdem, dann, danach, außerdem</b>.</p><div class='ex'>Ich bin müde, <b>denn</b> ich habe schlecht geschlafen.<br>Ich war krank, <b>deshalb bin</b> ich zu Hause geblieben.<br>Es regnet, <b>trotzdem gehe</b> ich joggen.</div><p><b>aber vs. sondern:</b> „sondern“ ersetzt „aber“ nur nach einer Verneinung, wenn das Gegenteil folgt — sonst immer „aber“.</p><div class='ex'>Er ist <b>nicht</b> müde, <b>sondern</b> hungrig. <span class='small'>(Widerspruch nach Verneinung)</span><br>Er ist müde, <b>aber</b> glücklich. <span class='small'>(kein Widerspruch)</span></div><p class='en'>und/oder/aber/denn don't change word order. deshalb/trotzdem/dann take position 1, so the verb comes immediately after. 'sondern' replaces 'aber' only after a negation when the opposite follows.</p>",
...
{q:"Er ist nicht traurig, ___ wütend.", o:["aber","sondern"], c:1, h:"Verneinung + Widerspruch → sondern."}
]},
...
{id:"untrennbar", chip:"unzertrennlich", title:"Untrennbare Verben: be-, ver-, ent- & Co.", titleEn:"Inseparable verbs",
explain:"<p>Acht Vorsilben trennen sich <b>nie</b> vom Verb: <b>be-, emp-, ent-, er-, ge-, ver-, zer-, miss-</b>. Sie bleiben unbetont, das Verb bleibt beim Sprechen ein Wort.</p><div class='ex'>besuchen → Ich <b>besuche</b> meine Oma.<br>verstehen → Verstehst du das? · erklären → Sie <b>erklärt</b> die Regel.</div><p>Im Perfekt gibt es <b>kein „ge-“</b>: be<b>sucht</b>, ver<b>standen</b>, er<b>klärt</b> — nicht „gebesucht“.</p><table class='wide'><tr><th>trennbar</th><th>untrennbar</th></tr><tr><td><b>ein</b>kaufen → Ich kaufe <b>ein</b>.<br>Perfekt: <b>ein</b>gekauft</td><td>ver<b>kaufen</b> → Ich <b>verkaufe</b> das Auto.<br>Perfekt: ver<b>kauft</b> (kein ge-)</td></tr></table><p class='en'>These 8 prefixes never separate and never take \"ge-\" in the perfect tense: be-, emp-, ent-, er-, ge-, ver-, zer-, miss-.</p>",
merk:"Trennbare Vorsilben sind oft ganze Wörter und werden betont (EINkaufen). Untrennbare Vorsilben sind kurz und unbetont (verKAUfen) — das hörst du im gesprochenen Deutsch.",
merkEn:"Separable prefixes are stressed whole words. Inseparable prefixes are short and unstressed.",
q:[
{q:"Wie heißt das Partizip II von „verkaufen“?", o:["geverkauft","verkauft","gekauft"], c:1, h:"ver- ist untrennbar → kein ge-."},
{q:"Welches Verb ist untrennbar?", o:["aufstehen","besuchen","mitkommen"], c:1, h:"be- trennt sich nie."},
{q:"Wo liegt die Betonung bei „verstehen“?", o:["VERstehen","versTEHen","verSTEhen"], c:1, h:"Bei untrennbaren Verben betont man den Verbstamm, nicht die Vorsilbe."},
{type:"gap", q:"Partizip II von „erklären“: ___", a:["erklärt"], h:"er- ist untrennbar, kein ge-, Endung -t."},
{type:"match", q:"Ordne die Vorsilbe der richtigen Gruppe zu:", pairs:[["ein-","trennbar"],["be-","untrennbar"],["auf-","trennbar"],["ver-","untrennbar"]], h:"ein-/auf- sind ganze Wörter, be-/ver- nicht."}
]},

{id:"wechselverben", chip:"liegen/legen", title:"Wechselverben: liegen/legen, stehen/stellen …", titleEn:"Position vs. movement verb pairs",
explain:"<div style='display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-bottom:12px;font-size:14px'><div style='background:#e9f8ee;border-radius:10px;padding:8px 14px;text-align:center'><b style='color:#248a3d'>◉ WO?</b><br><span style='font-size:12px;color:#6e6e73'>Position · Dativ · unregelmäßig</span></div><div style='background:#ffebe9;border-radius:10px;padding:8px 14px;text-align:center'><b style='color:#d70015'>➜ WOHIN?</b><br><span style='font-size:12px;color:#6e6e73'>Bewegung · Akkusativ · regelmäßig</span></div></div><p>Vier Verbpaare beschreiben entweder <b>Position</b> (wo? + Dativ) oder <b>Bewegung</b> (wohin? + Akkusativ) — mit unterschiedlichen Formen.</p><table class='wide'><tr><th>Position <span class='en'>(wo? + Dativ, unregelmäßig)</span></th><th>Bewegung <span class='en'>(wohin? + Akkusativ, regelmäßig)</span></th></tr><tr><td><b>liegen</b> — Das Buch liegt <span class='wd'>auf dem Tisch</span>.</td><td><b>legen</b> — Ich lege das Buch <span class='wa'>auf den Tisch</span>.</td></tr><tr><td><b>stehen</b> — Die Vase steht <span class='wd'>im Regal</span>.</td><td><b>stellen</b> — Ich stelle die Vase <span class='wa'>ins Regal</span>.</td></tr><tr><td><b>sitzen</b> — Das Kind sitzt <span class='wd'>auf dem Stuhl</span>.</td><td><b>setzen</b> — Ich setze das Kind <span class='wa'>auf den Stuhl</span>.</td></tr><tr><td><b>hängen</b> — Das Bild hängt <span class='wd'>an der Wand</span>.</td><td><b>hängen</b> — Ich hänge das Bild <span class='wa'>an die Wand</span>.</td></tr></table><p>Die linke Spalte ist <b>unregelmäßig</b> (lag, stand, saß, hing) und braucht kein Akkusativobjekt. Die rechte Spalte ist <b>regelmäßig</b> (legte, stellte, setzte) und braucht immer ein Akkusativobjekt.</p><p class='en'>Position verbs (liegen/stehen/sitzen/hängen) are irregular, intransitive, take dative. Movement verbs (legen/stellen/setzen/hängen) are regular, transitive, take accusative.</p>",
merk:"Frage dich: Wo ist etwas? → Position + Dativ. Wohin lege/stelle ich etwas? → Bewegung + Akkusativ.",
merkEn:"Ask: where is it (position+dative) or where am I putting it (movement+accusative)?",
q:[
{q:"Das Auto ___ vor dem Haus.", o:["liegt","steht","legt"], c:1, h:"Ein Auto steht — Position, unregelmäßig."},
{q:"Ich ___ die Tasse auf den Tisch.", o:["stehe","stelle","liege"], c:1, h:"stellen = Bewegung, regelmäßig: ich stelle."},
{q:"„Das Bild hängt ___ der Wand.“ Welcher Fall?", o:["Dativ (an der)","Akkusativ (an die)"], c:0, h:"Position (wo?) → Dativ."},
{type:"gap", q:"Er ___ sich auf den Stuhl. (Bewegung: sich hinsetzen)", a:["setzt"], h:"setzen = Bewegung + Akkusativ."}
]},

{id:"praepzeit", chip:"am · im · um", title:"Präpositionen der Zeit: am, im, um, seit, vor …", titleEn:"Time prepositions", ref:"praepositionen_bedeutung",
explain:"<p>Die häufigste Fehlerquelle bei Präpositionen ist nicht der Fall, sondern die <b>Bedeutung</b>: wann sagt man „am“, wann „im“, wann „um“?</p><table class='wide'><tr><th>Frage</th><th>Präposition</th><th>Beispiel</th></tr><tr><td>Wochentag / Tageszeit</td><td><b>am</b></td><td>am Montag · am Abend</td></tr><tr><td>Monat / Jahreszeit</td><td><b>im</b></td><td>im April · im Winter</td></tr><tr><td>genaue Uhrzeit</td><td><b>um</b></td><td>um 9 Uhr</td></tr><tr><td>Beginn bis jetzt</td><td><b>seit</b></td><td>seit 3 Jahren</td></tr><tr><td>Zeitpunkt in der Vergangenheit</td><td><b>vor</b></td><td>vor einer Stunde</td></tr><tr><td>Endpunkt</td><td><b>bis</b></td><td>bis Freitag</td></tr></table><p><b>Ausnahme:</b> „in der Nacht“ — Nacht braucht „in“, nicht „am“.</p><p class='en'>am = day/time of day, im = month/season, um = exact clock time, seit = since (ongoing), vor = ago, bis = until. Exception: \"in der Nacht\".</p>",
merk:"am + Tag/Tageszeit, im + Monat/Jahreszeit, um + genaue Uhrzeit — lerne diese drei zuerst.",
merkEn:"Learn am/im/um first — the three most common time prepositions.",
q:[
{q:"___ Montag habe ich Deutschkurs.", o:["Am","Im","Um"], c:0, h:"Wochentag → am."},
{q:"___ Winter fahre ich nach Deutschland.", o:["Am","Im","Um"], c:1, h:"Jahreszeit → im."},
{q:"Der Film beginnt ___ 20 Uhr.", o:["am","im","um"], c:2, h:"Genaue Uhrzeit → um."},
{type:"gap", q:"Ich wohne ___ 2020 in Cebu.", a:["seit"], h:"Andauernder Zeitraum → seit."},
{type:"gap", q:"___ der Nacht schlafe ich. (Ausnahme!)", a:["In"], h:"Nacht ist die Ausnahme: in der Nacht, nicht am Nacht."}
]}
]};
